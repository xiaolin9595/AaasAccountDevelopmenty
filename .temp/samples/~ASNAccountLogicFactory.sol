...
import "/home/node/workspace/AaasAcountTest/account-abstraction/node_modules/@openzeppelin/contracts/utils/Create2.sol";
import "/home/node/workspace/AaasAcountTest/account-abstraction/node_modules/@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";
...
contract ASNAccountLogicFactory {
    ...
    constructor(IEntryPoint _entryPoint, TxState _TxState) {
        accountImplementation = new ASNAccountLogic(_entryPoint, _TxState);
    }
